...
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=.3]{img/Salle.png}
	\vspace{.5cm}
	\label{img:img1}
	\caption{Espace de Test}
\end{figure}
...
par ce problème. Par la suite, nous sommes descendus au sous-sol du bâtiment pour avoir un large espace sans obstacles. \par
...
\begin{center}
    ...
    at={(0.5,1.03)},
    anchor=north}}
    \pgfplotstableread{p0.8_i0.008_d5.prn}{\table}
    \begin{axis}[
        xmin = 0, xmax = 8000,
        ymin = 0, ymax = 10,
    %    xtick distance = 1,
...
Encore une fois un comportement étrange. Le D qui serait beaucoup trop grand ?
...
\begin{center}
    ...
    at={(0.5,1.03)},
    anchor=north}}
    \pgfplotstableread{p0.8_i0.008_d5_A+2_B-5.prn}{\table}
    \begin{axis}[
        xmin = 0, xmax = 8000,
        ymin = 0, ymax = 10,
    %    xtick distance = 1,
    ...
    L'ajout d'une variable fixe ne permet pas de faire en sorte 
    de corriger le problème que nous avons. Le robot tourne de nouveau 
    sur lui-même alors même que les paramètres sont les mêmes que 
    la dernière fois. 
    ...
    at={(0.5,1.03)},
    anchor=north}}
    \pgfplotstableread{p0.8_i0.008_d5_A+2.prn}{\table}
    \begin{axis}[
        xmin = 0, xmax = 8000,
        ymin = 0, ymax = 10,
    %    xtick distance = 1,
    ...
    L'idée de changer le PWM en rajoutant ou en enlevant des PWM est une mauvaise idée.

\chapter{Conclusion}

Faute de temps, nous n'avons pas pu tester d'autres combinations de PID. Les différents tests ont 
