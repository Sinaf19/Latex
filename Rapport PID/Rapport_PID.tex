...
de l'expérience. Pour que le fichier de données soit lisible par \LaTeX\ nous devons changer deux trois trucs qu'il faudra préciser. \par
...
Nous allons montrer les différents graphiques que nous avons obtenu avec nos différentes expériences. \par

\section{Graphiques}

Les premiers graphiques présentés sont faits en roue libre. \par
...
\addplot[thick, blue, smooth] table [x = {x}, y = {y2}] {\table};

\addplot[thin, red, smooth] table [x = {x}, y = {y4}] {\table};
...
On peut voir que les courbes des ticks se rejoignent bien après l'erreur du repositionnement. \par
