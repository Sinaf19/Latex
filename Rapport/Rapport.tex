...
Notre processus administratif a évolué le long de notre projet. Nous avons d'abord commencé par les outils de la suite
Office365, puis nous avons divergé sur \LaTeX. Dans cette section nous allons expliquer d'abord
l'approche utiliser pour Office et ensuite l'approche pour \LaTeX.
