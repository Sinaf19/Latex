...
\chapter{Ce dont nous avons besoin}

\section{pip install = pip3 !!}

Installation de cmake via pip psk error message en boucle ... je pète un câble. Copier le script pip dans /usr/bin avec 
la commande : sudo cp /home/pi/.local/pip /usr/bin On y croit !!!


Downgrade version of pip
